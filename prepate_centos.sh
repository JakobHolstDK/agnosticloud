sudo dnf -y update
sudo dnf  install qemu-kvm qemu virt-manager virt-viewer libvirt-daemon python3-pip libvirt-daemon-system libvirt-clients dnsmasq qemu-utils  python3.8-venv pkg-config qemu-block-extra
